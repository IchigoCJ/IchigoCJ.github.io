document.addEventListener("DOMContentLoaded", () => {
    ...
    // Open book function
    function openBook() {
      // Animate the book closing
      bookCover.style.transform = "rotateY(-180deg)";
      
      // After animation, show the book content
      setTimeout(() => {
        ...
        // Fade in animation
        bookContent.style.animation = "fadeIn 1s ease-out";
      }, 1500);
    }
    ...
    function renderPage(pageIndex) {
      ...
      const bookContentDiv = document.querySelector(".book-content");
      ...
      if (template) {
        ...
        bookContentDiv.appendChild(clone);
    ...
    function initCrossword() {
      const questions = [
        ...
        { id: "cita", question: "Lugar de la primera cita", answer: "musas", direction: "across", row: 1, col: 2, length: 5 },
        { id: "postre", question: "Sabor del postre que te invité en la primera cita", answer: "coco", direction: "across", row: 2, col: 4, length: 4 },
        { id: "peluche", question: "Nombre de uno de mis peluches", answer: "spiderman", direction: "across", row: 3, col: 0, length: 9 },
        { id: "curso", question: "Mi curso favorito es", answer: "redes", direction: "across", row: 4, col: 3, length: 5 },
        { id: "animal", question: "Animal que más mencionamos", answer: "monky", direction: "across", row: 5, col: 1, length: 5 },
        { id: "declare", question: "Lugar donde me declaré", answer: "ruta6", direction: "across", row: 6, col: 2, length: 5 },
        { id: "picnic", question: "Donde hicimos nuestro picnic", answer: "pimentel", direction: "across", row: 7, col: 0, length: 8 },
      ];
